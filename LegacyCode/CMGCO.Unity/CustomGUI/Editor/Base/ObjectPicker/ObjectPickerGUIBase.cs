...
namespace CMGCO.Unity.CustomGUI.Base
{
    ...
    abstract public class ObjectPickerGUIBase : CustomGUIBase<int, GameObject>
    {
        ...
        protected virtual bool validateHasRequiredComponent(GameObject newGameObject)
        {
            return true; // This will need to be overloaded in any implementation that wants to do this. 
        }
